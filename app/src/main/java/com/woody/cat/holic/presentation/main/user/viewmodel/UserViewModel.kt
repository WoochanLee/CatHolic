...
class UserViewModel(private val settingRepository: SettingRepository): BaseViewModel() {
    ...
    private val _eventChangeDarkMode = MutableLiveData<Boolean>()
    val eventChangeDarkMode: LiveData<Boolean> get() = _eventChangeDarkMode
    ...
    fun changeDarkMode() {
        ...
        _eventChangeDarkMode.postValue(changedDarkMode)
    }
}