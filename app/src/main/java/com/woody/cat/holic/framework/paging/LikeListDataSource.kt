...
class LikeListDataSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, UserItem> {
        ...
        val nextKey = if (key + PAGE_SIZE > likeUserList.size) likeUserList.size else key + PAGE_SIZE
        val list = likeUserList.subList(key, nextKey).map {
