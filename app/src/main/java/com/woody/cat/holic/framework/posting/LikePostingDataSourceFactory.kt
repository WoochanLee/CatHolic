...
class LikePostingDataSourceFactory(
    ...
    private val _sourceLiveData = MutableLiveData<LikePostingDataSource>()

    override fun create(): DataSource<String, PostingItem> {
        val source = LikePostingDataSource(firebaseUserManager, GetLikePostings(postingRepository), scope, postingOrder)
